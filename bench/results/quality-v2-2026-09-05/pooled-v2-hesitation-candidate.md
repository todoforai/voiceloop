# Scoring v2.0: hesitation / candidate — 5 runs
...
| Voice→voice | 1328ms (p95 2452, n=30) |
...
| Reply word coverage, uninterrupted | 85.6% (30/30 observed) |
| Reply WER, uninterrupted | 14.8% |
| Incomplete replies (<80% words) | 4 / 30 |
| Stalls | 38 |
| Overlap / talked through | 2 / 0 |
| Yield | 600ms (p95 600, n=2) |
