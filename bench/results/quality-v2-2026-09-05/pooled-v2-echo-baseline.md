# Scoring v2.0: echo / baseline — 5 runs
...
| Voice→voice | 884ms (p95 2016, n=30) |
| Sustained barge-in stop | 1699ms (p95 2556, n=10) |
...
| STT WER (non-oracle attribution) | 14.6% (30 scored) |
...
| Yield | unknown |
| Echo words / filtered finals (lexical proxies) | 13 / 29 |
